...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("@moO0ra"))
...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("H_vv_G"))
    except BaseException:
        pass
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await sython1(JoinChannelRequest('moO0ra'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await sython1(JoinChannelRequest('moO0ra'))
